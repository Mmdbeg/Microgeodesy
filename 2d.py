...
# +-+-Load the Excel file +-+-+-+-+  
obs_path= 'out_dam_network_obs.xlsx' 
...
fixed_point = sp.Matrix([[xBL1],[yBL1]])
...
w0_BC3_to_BR1, w0_BL1_to_BL2, w0_BL2_to_BL3 = sp.symbols('w0_BC3_to_BR1 w0_BL1_to_BL2 w0_BL2_to_BL3')
w0_BL3_to_BL2, w0_BL4_to_BL5, w0_BL5_to_BL4 = sp.symbols('w0_BL3_to_BL2 w0_BL4_to_BL5 w0_BL5_to_BL4')
w0_BR1_to_BR3, w0_BR2_to_BR3 ,w0_BR3_to_BR1 ,w0_BR4_to_BR5, w0_BR5_to_BR4, w0_BR6_to_BL5= sp.symbols('w0_BR1_to_BR3 w0_BR2_to_BR3 w0_BR3_to_BR1 w0_BR4_to_BR5 w0_BR5_to_BR4 w0_BR6_to_BL5')

w0_s = sp.Matrix([[w0_BC3_to_BR1], [w0_BL1_to_BL2], [w0_BL2_to_BL3],
                  [w0_BL3_to_BL2], [w0_BL4_to_BL5], [w0_BL5_to_BL4],
                  [w0_BR1_to_BR3] ,[w0_BR2_to_BR3] ,[w0_BR3_to_BR1],
                  [w0_BR4_to_BR5], [w0_BR5_to_BR4] ,[w0_BR6_to_BL5]])
...
# azimoth_const = sp.Matrix([[mytan_sym_wrap(xBL1,xBL5,yBL1,yBL5)*(sp.pi/180)]])   # for bl1 => bl2
